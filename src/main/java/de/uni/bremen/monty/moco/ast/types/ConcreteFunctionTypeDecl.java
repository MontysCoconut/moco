...
public class ConcreteFunctionTypeDecl extends FunctionTypeDecl implements ConcreteFunctionType {
    ConcreteFunctionTypeDecl(FunctionDeclaration declaration, TypeContext context, List<? extends ConcreteVariableType> parameter, ConcreteType returnType, ConcreteType definingClass, ConcreteType wrapperClass, ConcreteVariableType wrapperFunctionObjects, List<ConcreteVariableType> closureVariables) {
    ...
    public List<ConcreteVariableType> getParameter() {
        return (List<ConcreteVariableType>) super.getParameter();
    }
    ...
    public List<ConcreteVariableType> getClosureVariables() {
        return (List<ConcreteVariableType>) super.getClosureVariables();
    }
