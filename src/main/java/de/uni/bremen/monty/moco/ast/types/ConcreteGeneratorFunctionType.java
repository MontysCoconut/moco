...
public class ConcreteGeneratorFunctionType extends ConcreteFunctionTypeDecl implements GeneratorFunctionType {
    ConcreteGeneratorFunctionType(GeneratorFunctionDeclaration declaration, TypeContext context, List<? extends ConcreteVariableType> parameter, ConcreteType returnType, ConcreteType definingClass, ConcreteType wrapperClass, ConcreteVariableType wrapperFunctionObjects, List<ConcreteVariableType> closureVariables) {
    ...
    @Override
    public List<ConcreteVariableType> getVariableDeclarations() {
